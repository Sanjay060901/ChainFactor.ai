...
# Provides invoice storage and frontend static hosting buckets.
...
# ---------------------------------------------------------------------------
# Frontend Static Hosting Bucket (private, served via CloudFront OAC)
# ---------------------------------------------------------------------------
...
# Enable static website hosting (required for SPA index.html routing)
