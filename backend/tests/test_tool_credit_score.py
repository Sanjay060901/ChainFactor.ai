...
class TestCreditScoreMockRules:
    ...
    def test_another_unknown_prefix(self):
        ...
        result = get_credit_score(buyer_gstin="06XYZAB1234R1ZZ")
        assert result["score"] == 650
        assert result["rating"] == "average"
